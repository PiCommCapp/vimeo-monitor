#!/usr/bin/env python3
"""
DEPRECATED: This is the old monolithic version of the Vimeo Monitor.

This script has been replaced by the new modular architecture:
- streammonitor.py (main script)
- config.py (configuration management)
- logger.py (logging with rotation)

DO NOT USE: This file is kept for reference only.
Use 'uv run streammonitor.py' instead.
"""
