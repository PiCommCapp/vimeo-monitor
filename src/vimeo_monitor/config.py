...
class Config:
    ...
    def __init__(self):
        ...
        self.vimeo_token: Optional[str] = os.getenv('VIMEO_TOKEN')
        self.vimeo_key: Optional[str] = os.getenv('VIMEO_KEY')
        self.vimeo_secret: Optional[str] = os.getenv('VIMEO_SECRET')
    ...
    def validate(self) -> None:
        ...
        if self.stream_selection not in self.streams:
            raise ValueError(f"Stream selection must be between 1 and {len(self.streams)}")
