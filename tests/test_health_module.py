...
class TestHealthMonitoringConfig(unittest.TestCase):
    ...
    def test_health_config_defaults(self):
        ...
        self.assertEqual(len(config.health_network_ping_hosts), 3)  # Default: 8.8.8.8, 1.1.1.1, vimeo.com
...
class TestHealthModuleIntegration(unittest.TestCase):
    ...
    def setUp(self):
        ...
        os.environ["HEALTH_METRICS_HOST"] = "127.0.0.1"
        os.environ["HEALTH_HARDWARE_ENABLED"] = "false"  # Disable hardware monitoring for testing
        os.environ["HEALTH_NETWORK_ENABLED"] = "false"  # Disable network monitoring for testing
        os.environ["HEALTH_STREAM_ENABLED"] = "false"  # Disable stream monitoring for testing
